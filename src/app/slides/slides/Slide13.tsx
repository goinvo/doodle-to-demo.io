...
export default function Slide13({ nextIndex }: { nextIndex?: number }) {
  return (
    <main className="gradient-bg relative min-h-[calc(100vh)] w-full px-4 py-6 sm:px-6">
       <section className="text-white w-full min-h-screen flex flex-col justify-center container-padding container-padding-vertical-quad">
          <h2 className=" text-[clamp(2rem,6vw+1rem,5rem)] tracking-tight">
            <span className="font-bold">Q&A</span> with
            <br/>the team
          </h2>
          <span className="font-mono">Conversation Starters</span>
