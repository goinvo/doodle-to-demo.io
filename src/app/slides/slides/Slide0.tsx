        ...
        <section className="order-2 col-span-12 md:order-1 md:col-span-8 md:flex md:items-center md:min-h-[calc(100vh-4rem)]">
          <div className="text-white">
            ...
            <p className="mt-6 text-[clamp(1rem,1.2vw+0.6rem,1.5rem)] opacity-90">
              View the presentation <a href="https://rosenverse.rosenfeldmedia.com/videos/from-doodle-to-demo-ai-as-our-storytelling-partner" target="_blank" rel="noopener noreferrer">here</a>, or follow along at your own pace by continuing to the next slide.
            </p>
            {/* <motion.div
              className="mt-8"
